...
class RemoteDataSource {
    suspend fun getUpcomingTrips() = listOf(
        ...
        UpcomingTripInfo("3","Anne L.","UrgVSL, VSL","Mardi 24 juin 2025","09:15 - 09:45","Lieu C > Lieu D", profilePicVector = Icons.Filled.Person),
        UpcomingTripInfo("1","Jean D.","Ambu81, VSL","Lundi 23 juin 2025","11:00 - 11:30","6 Rue Barclay > Hôpital de Castres")
    )
    ...
    suspend fun getNearbyTransporters() = listOf(
        TransporterInfo("1","UrgVSL","05 56 00 01 02","1.2 KM","4,8","120","Ouvert de 8h à 19h"),
